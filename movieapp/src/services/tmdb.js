...
const api = axios.create({ baseURL: BASE_URL, params: { api_key: API_KEY } });
...
export const tmdb = {
  // Added page parameter to trending
  getTrending: (lang, page = 1) => api.get('/trending/all/week', { params: { language: getLangCode(lang), page } }),
  ...
  // NEW: The Multi-Search endpoint
  searchMulti: (query, page = 1, lang) => api.get('/search/multi', { params: { query, page, language: getLangCode(lang) } })
};