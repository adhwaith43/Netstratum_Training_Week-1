...
function CustomizePanel({
    ...
    // open → panel visible or hidden
    // setOpen → function to close panel
    // setWallpaper → change wallpaper
    // showShortcuts → toggle shortcuts
    // setShowShortcuts → update shortcuts
    // shortcutRows → number of shortcut rows
    // setShortcutRows → change rows
    // showStories → show news cards
    // setShowStories → toggle news cards
